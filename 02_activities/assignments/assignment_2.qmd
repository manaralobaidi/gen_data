...
```{r}
# Find file
list.files("C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.A2.fam", pattern="\\.fam$")

# Read it
fam <- read.table("C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.A2.fam")
...
```{r}
bim <- read.table("C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.A2.bim")
nrow(bim)
# 306102 SNPs
```
...
```{r}
# Read .fam file
fam <- read.table("C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.A2.fam", header = FALSE)

# Extract phenotype (column 6)
pheno <- fam$V6

# Remove missing values (-9 in PLINK)
pheno <- pheno[pheno != -9]
...
lines(density(pheno), col = "blue", lwd = 2)

# QQ plot to assess normality
qqnorm(pheno)
qqline(pheno, col = "red")

#The histogram shows a roughly bell-shaped, symmetric distribution, so the phenotype appears approximately Gaussian.
...
plink2 --bfile C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.A2 --maf 0.05 --geno 0.01 --mind 0.1 --hwe 0.00005 --make-bed --out C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.qc.A2
```
...
```{bash}
plink2 \
  --bfile  C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.qc.A2 \
  --indep-pairwise 500 50 0.05 \
  --out  C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.qc.A2.pruned
```

```{bash}
plink2 \
  --bfile C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.qc.A2 \
  --extract C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.qc.A2.pruned.prune.in \
  --make-bed \
  --out C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.qc.A2.pruned
```
...
```{bash}
plink2 \
  --bfile C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.qc.A2.pruned \
  --king-cutoff 0.0884 \
  --out C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.qc.A2.king
```
...
plink2 \
  --bfile C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.qc.A2 \
  --keep C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.qc.A2.king.king.cutoff.in.id \
  --make-bed \
  --out C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.qc_unrelated.A2
```
...
```{bash,results='hide',message=FALSE, warning=FALSE}
plink2 --bfile C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.qc_unrelated.A2 --extract C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.qc.A2.pruned.prune.in --make-bed --out C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.qc_unrelated_pruned
```

```{bash,results='hide',message=FALSE, warning=FALSE}
plink2 --bfile  C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.qc_unrelated_pruned --pca 20 --out C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa_unrel_PCA
```
...
```{bash}
plink2 \
  --bfile C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.qc_unrelated.A2 \
  --pca 10 \
  --out C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.qc_unrelated.A2
```
```{bash}
plink2 \
  --bfile C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.qc_unrelated.A2 \
  --covar C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.qc_unrelated.A2.eigenvec \
  --covar-col-nums 3-5 \
  --linear \
  --out C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.results.A2
```
...
# Load GWAS results
assoc <- fread("C:/Users/USER/OneDrive/Desktop/gen_data/02_activities/data/gwa.results.A2.PHENO1.glm.linear")
